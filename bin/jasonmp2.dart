...
void main() {
  // Create some Bruno Mars songs
  var song1 = Song('Uptown Funk', 'Bruno Mars', 269); 
  var song2 = Song('Just the Way You Are', 'Bruno Mars', 221); 
  var song3 = Song('Grenade', 'Bruno Mars', 223); 
  var song4 = Song('Locked Out of Heaven', 'Bruno Mars', 233); 
  var song5 = Song('24K Magic', 'Bruno Mars', 227); 
  var song6 = Song('Treasure', 'Bruno Mars', 178); 
  var song7 = Song('The Lazy Song', 'Bruno Mars', 203); 
  ...
  var festival = MusicFestival('Bruno Mars Music Festival');
